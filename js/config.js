...
const REPORT_SECTIONS = Object.freeze([
  {
    ...
    fields: [
      ...
      { id: "principal", label: "مدير المدرسة",       type: "text", placeholder: "اسم مدير المدرسة", tooltip: "اسم مدير المدرسة" },
      { id: "year",      label: "العام الدراسي",      type: "text", placeholder: "مثال: ١٤٤٦هـ أو 1447هـ", tooltip: "العام الدراسي المطبق فيه الاختبار" },
      { id: "total",     label: "عدد الطلاب الكلي",   type: "number", min: 0, tooltip: "إجمالي عدد طلاب الصف المستهدف في المدرسة" },
      { id: "tested",    label: "عدد المختبرين",      type: "number", min: 0, tooltip: "عدد الطلاب الذين حضروا وأدوا الاختبار بالفعل" },
    ],
  },
  {
    id: "results",
    ...
    stats: [
      { id: "absent", label: "عدد الغياب", calc: "absent", tooltip: "عدد الطلاب الغائبين عن الاختبار (يحسب تلقائياً: الكلي − المختبرين)" },
      { id: "rate",   label: "نسبة المختبرين من العدد الكلي", calc: "rate", tooltip: "نسبة حضور الطلاب وتأديتهم للاختبار (تحسب تلقائياً)" },
    ],
  },
  {
    id: "overall-compare",
    tab: "basic",
    title: "نسبة المجتازين للحد الأدنى للإتقان في المجالات معًا",
    type: "compare",
    inputs: [
      { id: "y2025", label: "عام 2025", tooltip: "نسبة المجتازين للحد الأدنى للإتقان في جميع المجالات لعام 2025" },
      { id: "y2026", label: "عام 2026", tooltip: "نسبة المجتازين للحد الأدنى للإتقان في جميع المجالات لعام 2026" },
    ],
  ...
  /* ---------- التبويب الثاني: توزيع مستويات الأداء ---------- */
  {
    id: "levels",
    tab: "distribution",
    title: "توزيع نسب أداء الطلاب على مستويات الأداء في المواد الرئيسية",
    type: "subject-cards",
    subjects: [
    ...
    levelColumns: [
      { id: "high", label: "مرتفع", tooltip: "نسبة الطلاب المتميزين الذين حققوا أعلى درجة إتقان في المادة" },
      { id: "mid",  label: "متوسط", tooltip: "نسبة الطلاب الذين حققوا مستوى الإتقان المقبول للمهارات الأساسية" },
      { id: "low",  label: "منخفض", tooltip: "نسبة الطلاب الذين أداؤهم أقل من المتوقع ويحتاجون إلى دعم وتطوير" },
      { id: "vlow", label: "منخفض جدًا", tooltip: "نسبة الطلاب في أدنى مستويات الأداء ويحتاجون لخطط علاجية مكثفة" },
    ],
    percentColumns: [
      { id: "y2026",       label: "المجتازون 2026", tooltip: "نسبة الطلاب الذين اجتازوا مستوى الحد الأدنى للإتقان في العام الحالي 2026" },
      { id: "y2025",       label: "المجتازون 2025", tooltip: "نسبة اجتياز الحد الأدنى للإتقان في العام الماضي 2025" },
    ...
    charts: [
      {
        ...
        description: "توزيع الطلاب على المستويات الأربعة لكل مادة كما دُخلت في البطاقات أعلاه (تُعرض النسب كما هي دون تقييد الجمع على 100%).",
        emptyText: "أدخل نسب مستويات الأداء في بطاقات المواد أعلاه لعرض المخطط",
        height: 340,
      },
      /*
      {
        id: "chart-benchmarks",
        type: "benchmarks",
        title: "مقارنة المجتازين 2026 بالمؤشرات المعيارية",
        description: "مقارنة نتيجة المدرسة لعام 2026 مع نتيجة 2025 ومتوسط الإدارة والمتوسط الوطني والمستهدف.",
        emptyText: "أدخل نسب المجتازين في بطاقات المواد أعلاه لعرض المخطط",
        height: 360,
      },
      */
    ],
  ...
  /* ---------- التبويب الثالث: المجالات الفرعية ---------- */
  {
    ...
    tab: "subdomains",
    title: "نسبة الطلاب الذين اجتازوا مستوى الحد الأدنى للإتقان في المجالات الفرعية",
    ...
    charts: [
      {
        idPrefix: "chart-sub-",
        type: "subdomains",
        title: "مقارنة المجتازين في المجالات الفرعية: 2026 مقابل 2025",
        description: "نتيجة كل مجال فرعي لعام 2026 مقارنة بعام 2025 — المجالات التي تفتقد نتيجة 2025 تظهر بقيمة واحدة فقط.",
        emptyText: "أدخل نسب المجتازين في الجدول أعلاه لعرض المخطط",
      }
    ]
  },
